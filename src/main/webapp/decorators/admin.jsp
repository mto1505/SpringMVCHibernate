...
<!-- font awesome -->
<script src="<c:url value='/statics/ckeditor/ckeditor.js'/>"></script>
 <script src="<c:url value='/statics/ckfinder/ckfinder.js'/>"></script> 
...
<!-- table-detail -->
<link rel="stylesheet"
	href="<c:url value='/template/admin/css/table-detail.css'/>" />
<!-- validate form -->
<!--Product Element Form css-->
<link rel="stylesheet"
	href="<c:url value='/template/admin/css/form-add-product.css'/>" />
<!-- Product Form element js -->
