...
<c:url var="addCTSanPham" value="/quan-tri/product-detail/add" />
					...
					<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<form action="${addCTSanPham}?product=${sanPham}" modelAttribute="chiTietSanPham"
